...
import com.one.domain.BookLoanType;
...
import com.one.mapper.BookLoanMapper;
...
import com.one.service.FineCalculationService;
...
public class BookLoanServiceImpl implements BookLoanService {
    ...
    @Override
    public BookLoanDTO updateBookLoan(Long bookLoanId, com.one.payload.request.UpdateBookLoanRequest updateRequest) throws BookLoanException {
        // 1. Validate book loan exists
        BookLoan bookLoan = bookLoanRepository.findById(bookLoanId)
                .orElseThrow(() -> new BookLoanException("Book loan not found with id: " + bookLoanId));
