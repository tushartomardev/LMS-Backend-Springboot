...
import com.one.domain.PaymentStatus;
import com.one.domain.PaymentType;
import com.one.exception.PaymentException;
import com.one.exception.SubscriptionException;
import com.one.exception.UserException;
import com.one.mapper.SubscriptionMapper;
import com.one.modal.Payment;
import com.one.modal.Subscription;
import com.one.modal.SubscriptionPlan;
import com.one.modal.User;
import com.one.payload.dto.SubscriptionDTO;
import com.one.payload.request.PaymentInitiateRequest;
import com.one.payload.request.SubscribeRequest;
import com.one.payload.response.PaymentInitiateResponse;
import com.one.repository.PaymentRepository;
import com.one.repository.SubscriptionRepository;
import com.one.repository.UserRepository;
import com.one.service.PaymentService;
import com.one.service.SubscriptionService;
import com.one.service.UserService;
import com.one.service.gateway.RazorpayService;
import com.one.service.gateway.StripeService;
...
public class SubscriptionServiceImpl implements SubscriptionService {
    ...
    private final com.one.repository.SubscriptionPlanRepository subscriptionPlanRepository;
